...
Writes docs/resources/bench-breadboard.svg, which docs/bench-wiring.md embeds.
...
text(MARGIN_X, 62, "Everything hangs off XIAO-ESP32S3-cam. XIAO-ESP32S3-lora gets nothing but the two battery wires.", 13, NOTE)
...
dest = os.path.normpath(os.path.join(here, "..", "..", "docs", "resources", "bench-breadboard.svg"))
