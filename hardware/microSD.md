...
__Video only, and already in hand.__ Rides the Sense expansion board on the recorder's SPI.
...
> __The card is the more durable of the two records.__ If the recorder resets in flight the PSRAM log is gone entirely and __the SD video survives__. Worth remembering when deciding what the firmware writes and when.
