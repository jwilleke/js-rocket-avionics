...
Generated by [`gen_carrier_diagram.py`](../scripts/gen_carrier_diagram.py) from `PCB-carrier.kicad_pcb`. Regenerate it, do not edit it. It draws only what is placed: the outline, the holes and both XIAOs. The sensors, buzzer, L76K, JST and battery are still numbers until [#14](https://github.com/jwilleke/js-rocket-avionics/issues/14) stage 2c.
