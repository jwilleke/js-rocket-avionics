...
| Project | For | State |
|---|---|---|
| [`bringup-cam/`](bringup-cam/) | [XIAO-ESP32S3-cam](../hardware/XIAO-ESP32S3-cam/XIAO-ESP32S3-cam.md) + [Sense-camera-board](../hardware/Sense-camera-board/Sense-camera-board.md) bench bring-up, [#7](https://github.com/jwilleke/js-rocket-avionics/issues/7) | __run 2026-09-12__: I2C and IMU pass. Camera and microSD not yet run — no Sense board fitted; the microSD code now uses Seeed's SPI wiring (CS on GPIO21), untested |
